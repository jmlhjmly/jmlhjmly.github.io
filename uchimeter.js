...
window.onload = function() {
    ...
    //BuiYaki(塩, タレ, 素焼き, 味噌)
    //レバ
    const rebaObj = new BuiYaki(48, 70, 8, 21);
    ...
    //アブラ
    const aburaObj = new BuiYaki(11, 117, 4, 9);
