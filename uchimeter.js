...
window.onload = function() {
    ...
    //Oshinko(お新香, 大根)
    const oshinkoObj = new Oshinko(86, 150);
    const oshinkoArray = oshinkoObj.getOshinkoArray();

    //drinkObj(ウメ, ブドウ, ビール, 小瓶, ウーロン茶)
    const drinkObj = new Drink(552.5, 162, 1, 2, 2);
