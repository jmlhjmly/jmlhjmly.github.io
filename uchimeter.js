...
window.onload = function() {
    ...
    //Oshinko(お新香, 大根)
    const oshinkoObj = new Oshinko(77, 121);
    const oshinkoArray = oshinkoObj.getOshinkoArray();

    //drinkObj(ウメ, ブドウ, ビール, 小瓶, ウーロン茶)
    const drinkObj = new Drink(492.5, 121, 1, 2, 2);
